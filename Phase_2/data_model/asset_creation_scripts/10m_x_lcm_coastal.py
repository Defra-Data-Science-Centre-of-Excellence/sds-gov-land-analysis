...
focal_name_1 = "lcm_coastal"
focal_name_2 = "lcm_saltmarsh"

focal_path = "/mnt/lab/restricted/ESD-Project/Defra_Land/Layers/LCM_Eng.parquet"

focal_column = 'f_mode'

focal_variable_1 = [13,15,16,17,18,19]
focal_variable_2 = 19
...
focal_layer_1 = focal_layer.filter(focal_layer[focal_column].isin(focal_variable_1)) 
