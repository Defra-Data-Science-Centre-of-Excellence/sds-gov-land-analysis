...
parquet_list = [f"{alt_par_path}/{grid_square_size}m_x_dgl_fh.parquet",
                      ...
                      f"{alt_le_path}/{grid_square_size}m_x_le_urban.parquet",
                      f"{alt_lcm_path}/{grid_square_size}m_x_lcm_urban.parquet",
                      f"{alt_lcm_path}/{grid_square_size}m_x_lcm_suburban.parquet",
                      f"{alt_par_path}/{grid_square_size}m_x_ons_urban.parquet"]
...
exclude_columns = set(lcm_columns)
...
data_combined.write.format("parquet").mode("overwrite").save(
    f"{alt_out_path}/10m_x_assets_combined_urban.parquet"
)
