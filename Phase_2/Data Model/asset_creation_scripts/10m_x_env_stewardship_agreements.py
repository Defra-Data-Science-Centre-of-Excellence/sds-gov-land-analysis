...
focal_name = "env_steward_agreement" # used to name the layer in outputs
focal_path = "dbfs:/mnt/base/unrestricted/source_rpa_spatial_data_mart/dataset_environmental_stewardship_agreement_boundaries/format_GEOPARQUET_environmental_stewardship_agreement_boundaries/LATEST_environmental_stewardship_agreement_boundaries/es_agreement_ext.parquet"
...
focal_layer_validated = spark.sql(
    """
    SELECT 
        CASE 
...
focal_layer_validated.createOrReplaceTempView("focal_layer")
