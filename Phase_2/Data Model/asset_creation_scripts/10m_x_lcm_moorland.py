...
focal_name_1 = "lcm_heather"
focal_name_2 = "lcm_heather_grass"  # used to name the layer in outputs
focal_name_3 = "lcm_bog"  
...
focal_layer_3 = focal_layer.filter(focal_layer[focal_column] == focal_variable_3) 
