...
# MAGIC %md
# MAGIC ### Rasterisation - SUM Version - Semi-Natural Grasslands
...
data_combined = sedona.read.format("parquet").load(
    f"{alt_par_path}/10m_x_assets_combined_grassland.parquet"
)
...
columns_to_sum = ["le_unimproved_grass","phi_comb","lcm_comb"]
...
tif_file = "/tmp/dgl_grassland_sum.tif"
