...
# MAGIC %md
# MAGIC ### Rasterisation - SUM Version - Water
...
data_combined = sedona.read.format("parquet").load(
    f"{alt_par_path}/10m_x_assets_combined_water.parquet"
)
...
columns_to_sum = ["le_comb","lcm_comb","phi_comb","os_ngd_water"]
...
tif_file = "/tmp/dgl_water_sum.tif"
