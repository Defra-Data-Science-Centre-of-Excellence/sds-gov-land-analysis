...
# MAGIC %md
# MAGIC
# MAGIC # Intersect OS NGD Water Features with Data Model Grid (10m)
# MAGIC
...
focal_path = "dbfs:/mnt/base-res-os-premium/restricted/source_ordnance_survey_data_hub/dataset_ngd_water_features/format_GEOPARQUET_ngd_water_features/LATEST_ngd_water_features/wtr_fts_water/wtr_fts_water.parquet"
